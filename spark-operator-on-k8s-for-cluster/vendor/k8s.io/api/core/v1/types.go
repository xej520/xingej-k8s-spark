...
type VolumeSource struct {
	...
	// More info: https://releases.k8s.io/HEAD/examples/kafka-cinder-pd/README.md
	// +optional
...
// Service is a named abstraction of software service (for example, kafka) consisting of local port
