...
type SparkClusterLister interface {
	...
	List(selector labels.Selector) (ret []*v1beta1.SparkCluster, err error)
...
// List lists all SparkClusters in the indexer.
func (s *sparkClusterLister) List(selector labels.Selector) (ret []*v1beta1.SparkCluster, err error) {
	err = cache.ListAll(s.indexer, selector, func(m interface{}) {
		ret = append(ret, m.(*v1beta1.SparkCluster))
	})
	return ret, err
}
...
type SparkClusterNamespaceLister interface {
	...
	Get(name string) (*v1beta1.SparkCluster, error)
...
// List lists all SparkClusters in the indexer for a given namespace.
func (s sparkClusterNamespaceLister) List(selector labels.Selector) (ret []*v1beta1.SparkCluster, err error) {
...
// Get retrieves the SparkCluster from the indexer for a given namespace and name.
func (s sparkClusterNamespaceLister) Get(name string) (*v1beta1.SparkCluster, error) {
	obj, exists, err := s.indexer.GetByKey(s.namespace + "/" + name)
	if err != nil {
		return nil, err
	}
	if !exists {
		return nil, errors.NewNotFound(v1beta1.Resource("sparkcluster"), name)
	}
	return obj.(*v1beta1.SparkCluster), nil
}
