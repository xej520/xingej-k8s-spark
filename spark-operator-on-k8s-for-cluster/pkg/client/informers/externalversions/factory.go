...
import (
	...
	spark "xingej-go/xingej-k8s-spark/spark-operator-on-k8s-for-cluster/pkg/client/informers/externalversions/spark"
...
func (f *sharedInformerFactory) Spark() spark.Interface {
